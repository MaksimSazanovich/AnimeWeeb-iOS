...
extension TitleDTO {
    func toDomain() -> AnimeModel {
        AnimeModel(id: id, imageURL: URL(string: posterURL), title: nameRu, description: description, genres: genres.compactMap { $0.toDomain() }, nameRu: nameRu, nameEn: nameEn, nameJp: nameJp, altNamesRu: altNamesRu, altNamesEn: altNamesEn )
    }
}
